...
class NotificationType(str, Enum):
    ...
    AI_FINDING_REVIEW_REQUIRED = "AI_FINDING_REVIEW_REQUIRED"
    SUBSCRIPTION_PAYMENT_REMINDER = "SUBSCRIPTION_PAYMENT_REMINDER"
    ENTERPRISE_REQUEST_SUBMITTED = "ENTERPRISE_REQUEST_SUBMITTED"
    ENTERPRISE_REQUEST_APPROVED = "ENTERPRISE_REQUEST_APPROVED"
    ENTERPRISE_REQUEST_REJECTED = "ENTERPRISE_REQUEST_REJECTED"
    ENTERPRISE_ACTIVATED = "ENTERPRISE_ACTIVATED"


class EnterpriseRequestStatus(str, Enum):
    PENDING = "PENDING"
